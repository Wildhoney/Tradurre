...
export const dictionary = i18n.dictionary({
  price: i18n.template<Tokens.Price>({
    [Locale.En]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "GBP" })
    ...
    [Locale.It]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "EUR" })
        .format(tokens.amount);
    },
    [Locale.Es]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "EUR" })
        .format(tokens.amount);
    },
    [Locale.Ar]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "AED" })
        .format(tokens.amount);
    },
    [Locale.Ja]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "JPY" })
        .format(tokens.amount);
    },
    [Locale.Ru]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "RUB" })
        .format(tokens.amount);
    },
    [Locale.Uk]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "UAH" })
        .format(tokens.amount);
    },
    [Locale.Ka]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "GEL" })
        .format(tokens.amount);
    },
    [Locale.Zh]({ tokens, format }) {
      return format
        .number({ style: "currency", currency: "CNY" })
        .format(tokens.amount);
    },
  }),

  espressoName: i18n.constant({
    [Locale.En]: "Espresso",
    [Locale.Fr]: "Expresso",
    [Locale.De]: "Espresso",
    [Locale.It]: "Espresso",
  ...
  espressoDescription: i18n.constant({
    [Locale.En]:
  ...
  cappuccinoDescription: i18n.constant({
    [Locale.En]:
  ...
  latteDescription: i18n.constant({
    [Locale.En]:
  ...
  mochaDescription: i18n.constant({
    [Locale.En]:
  ...
  americanoDescription: i18n.constant({
    [Locale.En]:
  ...
  flatWhiteDescription: i18n.constant({
    [Locale.En]:
